...
type Message struct {
	...
	// added by @skoya76
	Rtt               *int64 `protobuf:"varint,15,opt,name=rtt" json:"rtt,omitempty"`
	SendTime          *int64 `protobuf:"varint,16,opt,name=send_time,json=sendTime" json:"send_time,omitempty"`
	SequenceId        *int64 `protobuf:"varint,17,opt,name=sequence_id,json=sequenceId" json:"sequence_id,omitempty"`
	HeartbeatInterval *int64 `protobuf:"varint,18,opt,name=heartbeat_interval,json=heartbeatInterval" json:"heartbeat_interval,omitempty"`
}
...
var fileDescriptor_b042552c306ae59b = []byte{
	...
	,
}
...
func (m *Message) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.HeartbeatInterval != nil {
		i = encodeVarintRaft(dAtA, i, uint64(*m.HeartbeatInterval))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x90
	...
	if m.SequenceId != nil {
		i = encodeVarintRaft(dAtA, i, uint64(*m.SequenceId))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x88
	...
	if m.SendTime != nil {
		i = encodeVarintRaft(dAtA, i, uint64(*m.SendTime))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x80
	...
	if m.Rtt != nil {
		i = encodeVarintRaft(dAtA, i, uint64(*m.Rtt))
		i--
		dAtA[i] = 0x78
	}
...
func (m *Message) Size() (n int) {
	...
	if m.Rtt != nil {
		n += 1 + sovRaft(uint64(*m.Rtt))
	}
	if m.SendTime != nil {
		n += 2 + sovRaft(uint64(*m.SendTime))
	}
	if m.SequenceId != nil {
		n += 2 + sovRaft(uint64(*m.SequenceId))
	}
	if m.HeartbeatInterval != nil {
		n += 2 + sovRaft(uint64(*m.HeartbeatInterval))
	}
	return n
}

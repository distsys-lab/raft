...
type Message struct {
	...
	SendTime          uint64 `protobuf:"varint,15,opt,name=send_time,json=sendTime" json:"send_time"`
	SequenceId        uint64 `protobuf:"varint,16,opt,name=sequence_id,json=sequenceId" json:"sequence_id"`
	HeartbeatInterval uint64 `protobuf:"varint,17,opt,name=heartbeat_interval,json=heartbeatInterval" json:"heartbeat_interval"`
}
...
var fileDescriptor_b042552c306ae59b = []byte{
	...
	,
}
